...
out_dir="/edgehpc/dept/compbio/projects/SingleCell/results/dev/mouse_cuprizone_DE/CRZ_vs_RCV_ambient_doublet_removed"
log_dir="${out_dir}/log"
...
--out_dir $out_dir \
--out_prefix nebula_hl_crz_vs_rcv \
--volcano
"
srun --job-name=nebula_hl_${celltype}_crz_vs_rcv -o $log_dir/nebula_hl_${celltype}_crz_vs_rcv.log -p cpu --time='300:00:00' --mem-per-cpu=512G bash -c "$multiline" &
done